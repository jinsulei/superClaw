...
| uv-python | needs_clean_source_snapshot | reviewed portable Python runtime source | needs_clean_source_checksum | yes_after_review | Hermes Python execution / portable agent runtime | `resources/runtime/uv-python/` | `src-tauri/resources/runtime/uv-python/` | needs_license_review | needs_size_review | needs_review |
| uv-tools | needs_clean_source_snapshot | reviewed uv tools runtime source | needs_clean_source_checksum | yes_after_review | Hermes uv tool execution / portable dependency tooling | `resources/runtime/uv-tools/` | `src-tauri/resources/runtime/uv-tools/` | needs_license_review | needs_size_review | needs_review |
