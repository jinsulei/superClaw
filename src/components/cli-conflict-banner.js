...
const STORAGE_KEY = 'superclaw-cli-conflict-dismissed-paths'

// 已知良性来源：这些 IDE/客户端会自带一份 openclaw，跟 SuperClaw 共存不会出问题——
// Tauri 后端的 `is_rejected_cli_path` 已排除它们，不会被 SuperClaw 选用；
