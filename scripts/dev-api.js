...
async function fetchReadableUrlContent(rawUrl) {
  ...
  try {
    ...
    lines.push(
      '',
      '[读取限制]',
      '当前只读取到了短视频分享页的公开标题、描述、封面或页面文本片段；如果缺少口播、字幕和完整画面，请先基于已读字段输出【有限文稿分析】，至少包含选题/标题方向、可能受众、开场钩子推断、卖点或情绪点、可仿写方向；同时输出【有限文稿时间轴】和【几句话文稿推断】，用开场句、承接句、转折句、收束句表达，不编造真实时间戳。不要声称已经读取完整视频正文、逐字稿、字幕、画面 OCR 或音频转写。',
